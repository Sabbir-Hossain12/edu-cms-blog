    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Events Categories</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Pages</a></li>
                        <li class="breadcrumb-item active">Events Categories</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title">Events Categories List</h4>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Events Category</h5>
                ...
                <div class="modal-body">
                    <form name="form" id="createAdmin">
                        ...
                        <div class="mb-3">
                            <label for="email" class="col-form-label">Category Thumbnail (600 × 600 px) *</label>
                        ...
                        <div class="mb-3">
                            <label for="event_time" class="col-form-label">Event Time</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="form2" id="editAdmin">
                        ...
                        <div class="mb-3">
                            <label for="eevent_type" class="col-form-label">Event Type</label>
                            <input type="text" class="form-control" id="eevent_type" name="event_type" required>
                        </div>

                        <div class="mb-3">
                            <label for="eevent_time" class="col-form-label">Event Time</label>
                            <input type="datetime-local" class="form-control" id="eevent_time" name="event_time" required>
                        </div>
                ...
                $.ajax(
                    {
                        ...
                        success: function (res) {
                            ...
                            $('#eevent_type').val(res.data.event_type);
