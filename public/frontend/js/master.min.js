...
!function (a) {
    ...
    !function () {
        ...
        b.prototype.add = function (a) {
            ...
            var a = this.Adapter.isEmptyObject(this.waypoints.horizontal),
                b = this.Adapter.isEmptyObject(this.waypoints.vertical), c = this.element == this.element.window;
            ...
            for (var c in b) {
                ...
                for (var g in this.waypoints[c]) {
                    ...
                    if (null !== h.triggerPoint) {
                        var i = d.oldScroll < h.triggerPoint, j = d.newScroll >= h.triggerPoint, k = i && j,
                            l = !i && !j;
            ...
            for (var f in a) {
                ...
                for (var h in this.waypoints[f]) {
                    var i, j, k, l, m, n = this.waypoints[f][h], o = n.options.offset, p = n.triggerPoint, q = 0,
                        r = null == p;
    ...
    !function (e, f, g) {
        ...
        function r(a, b) {
            ...
            return b = p(d, f, b), {key: d, modifiers: f, action: b}
        }
        ...
        function t(a) {
            ...
            function c(a, b, c, d, e, f) {
                ...
                for ("keyup" == k && n(a) && (b = [a]), g = 0; g < q._callbacks[a].length; ++g) if (h = q._callbacks[a][g], (d || !h.seq || u[h.seq] == h.level) && k == h.action && ("keypress" == k && !c.metaKey && !c.ctrlKey || j(b, h.modifiers))) {
                    var l = !d && h.combo == e, m = d && h.seq == d && h.level == f;
            ...
            function o(a, c, e, f) {
                ...
                for (var j = 0; j < c.length; ++j) {
                    var k = j + 1 === c.length, l = k ? h : function (b) {
                        return function () {
                            x = b, ++u[a], g()
                        }
                    }(f || r(c[j + 1]).action);
            ...
            function p(a, b, d, e, f) {
                ...
                g = r(a, d), q._callbacks[g.key] = q._callbacks[g.key] || [], c(g.key, g.modifiers, {type: g.action}, e, a, f), q._callbacks[g.key][e ? "unshift" : "push"]({
                    callback: b,
            ...
            q._handleKey = function (a, e, f) {
                ...
                for (g = 0; g < h.length; ++g) if (h[g].seq) {
    ...
    if (d.expr[":"].external = function (a) {
        ...
        var e = function (a) {
            var b = d(a),
                ...
                e = b.data("ga-action") || b.is("a") && a.hostname || "click", f = b.data("ga-label") || a.href;
            // ga("send", "event", c, e, f)
        };
        d("a:external").click(function () {
            ...
            var a = d(this), b = a.closest("[data-ga-category]").data("ga-category"),
    ...
    if (d("body.home").length > 0) {
        c(1), c(31);
        var f = function (a, b) {
            // console.log("Tracking scroll: category=Homepage scroll, action=" + a + ", label=" + b), ga("send", "event", "Homepage scroll", a, b)
        };
        d('section[data-type="section"] > header > h2').each(function (a, b) {
            new Waypoint.Inview({
                element: d(b).closest("section")[0], entered: function (a) {
    ...
    "use strict";
    var d = jQuery;
    window.location.hostname.indexOf("stanford.edu") < 0 && d("body").append('<aside id="breakpoint-helper" tabindex="-1" aria-hidden="true"></aside>').addClass("bp-helper")
}, function (a, b, c) {
    "use strict";
    c(28).attach(document.body)
}, function (a, b, c) {
    "use strict";
    var d = jQuery, e = c(3), f = c(0), g = f.splashPanel(), h = f.homePage(), i = (f.mobileMenu(), c(2)),
        j = i.splashPanel(), k = document.getElementById("search-field"), l = document.getElementById("menu-toggle"),
        m = document.getElementById("search-toggle"), n = document.querySelector("#menu-gateway-nav li:last-of-type a"),
        o = document.querySelector("#site-search p a:last-of-type"),
        p = document.querySelector("#site-navigation li:first-child a"),
        q = document.getElementById("splash--scroller"), r = d("#brand-bar"), s = (d("#main"), d("#main-content")),
        t = d("#search-toggle"), u = d("#site-navigation"), v = d(j).outerHeight(), w = d(r).outerHeight(),
        x = d(u).outerHeight(), y = d(l), z = null, A = null, B = null, C = null;
    d(window).on("navKeyboardBindings", function () {
        f.mobileMenu() ? (n && (z && z.unbind("tab"), z = new e(n).bind("tab", function () {
            ...
            g && h && (d("html body").animate({scrollTop: d(s).offset().top + v - x - w}, 400), d(s).focus())
        }))
    ...
    function d(a) {
        g(("alpha" == a ? ".post-type-archive-atoz" : ".archive.tax-list") + " #list-filters li").each(function () {
            var b = g(this), c = b.children("a").first().data("filter"),
    ...
    var g = jQuery, h = c(3), i = document.querySelector("#list > h2"), j = null;
    if (d("alpha"), d("term"), g(".archive.tax-list #list-filters a.show-tag").click(function (a) {
        a.preventDefault();
        var b = g(this), c = b.data("filter");
    ...
    !function (b, c, d) {
        ...
        var m = c.documentElement, n = "svg" === m.nodeName.toLowerCase();
        n || function (b, c) {
            function d(a, b) {
            ...
            var l, m, n = b.html5 || {}, o = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,
        ...
        }), k.testStyles = h, function () {
            var a, b, c, d, f, g, h;
            for (var k in j) if (j.hasOwnProperty(k)) {
                if (a = [], b = j[k], b.name && (a.push(b.name.toLowerCase()), b.options && b.options.aliases && b.options.aliases.length)) for (c = 0; c < b.options.aliases.length; c++) a.push(b.options.aliases[c].toLowerCase());
    ...
    d("#menu-toggle, #menu-overlay").click(function () {
        ...
        if ("true" === e.attr("aria-expanded")) d(a).attr("aria-expanded", "false"), d(e).html("Menu"), f.removeClass("blur"); else {
            var b = d("#search-toggle");
            "true" === d(b).attr("aria-expanded") && b.click(), d(a).attr("aria-expanded", "true"), d(e).html("Close"), f.addClass("blur")
        }
    })
}, function (a, b, c) {
    "use strict";
    ...
    d(window).on("panelImageContentAdjust", function () {
        d('[data-type="image-content"]').each(function () {
            var a = c(0), b = a.breakpointDetect();
            if ("xs" === b || "sm" === b) {
                var e = d(this).find(".content:last-child").css("padding-right"), f = parseInt(e),
                    g = d(this).find("figcaption").outerHeight(), e = 2 * f + g, h = -(2 * f + g);
    ...
    "use strict";
    var d = jQuery, e = (c(1), c(0)), f = e.mobileMenu(),
        g = (d("body > header"), d("#main"), d("body > footer"), d("#brand-bar")), h = d("#site-navigation"),
        i = d('[data-type="profile"]'), j = d(g).outerHeight(), k = d(h).outerHeight();
    d(i).each(function () {
        var a = d(this), b = null;
        a.attr("data-hide-content", "true"), a.waypoint(function (c) {
            "down" === c ? "chrome" !== b && (console.log("Reveal Profile Panel Contents - Sweet Spot"), a.removeAttr("data-hide-content"), b = "sweetSpot") : "sweetSpot" === b && (console.log("Hide Profile Panel Contents, scrolling up - Sweet Spot"), a.attr("data-hide-content", "true"))
        }, {
            offset: function () {
            ...
            "down" === c ? "sweetSpot" !== b && (console.log("Reveal Profile Panel Contents"), a.removeAttr("data-hide-content"), b = "chrome") : "chrome" === b && (console.log("Hide Profile Panel Contents, scrolling up"), a.attr("data-hide-content", "true"))
        }, {
            offset: function () {
                return !0 === f ? j : k + j
            }
    ...
    function d() {
        switch (e(), t.addClass(y), u.addClass("splash"), F("#splash-video")[0] && (n(), v.click(m), w.click(m)), F("#splash-video").click(o), F("#splash--pause").click(o), F("#splash-video").on("ended", k), z) {
            case"parallax":
                B = "below", s.addClass(y), j(), v.on("open", function () {
                    g("below" === B)
                }), v.on("close", function () {
                    g("above" !== B)
                });
            ...
            case"curtain":
            default:
                E = F('<div id="main-spacer"></div>').attr("aria-role", "presentation").css("visibility", "hidden").css("height", q.height()).css("z-index", "-100").insertAfter(q), f(!0), i()
        }
    }

    function e() {
        if (x) {
            var a = F(window).innerHeight(), b = s.outerHeight(), c = a - b + 1;
            x.css("height", c)
        }
    }
    ...
    function f(a) {
        if (a) {
            var b = G.mobileMenu(), c = s.outerHeight(), d = t.outerHeight(), e = E.outerHeight(),
                f = b ? c : c + d - 10;
            q.addClass("fixed").css("margin-top", f),
                E.css("height", e + f).css("display", "block"), F("#splash-video").length && !F("#splash-video").hasClass("paused") && "true" !== v.attr("aria-expanded") && "true" !== w.attr("aria-expanded") && (F("#splash-video")[0].play(), l())
        } else q.removeClass("fixed").css("margin-top", 0), E.css("display", "none"), F("#splash-video").length && (F("#splash-video")[0].pause(), k())
    }

    function g(a) {
        a ? (t.removeClass("shadow").addClass(y), s.addClass(y)) : (t.addClass("shadow").removeClass(y), s.removeClass(y))
    }

    function h() {
        return -(x.outerHeight() - t.outerHeight() - s.outerHeight() - parseFloat(t.css("font-size")))
    }

    function i() {
        x.waypoint(function (a) {
            "down" === a ? t.addClass("shadow").removeClass(y) : "up" === a && t.removeClass("shadow").addClass(y)
        }, {offset: h}), p.waypoint(function (a) {
            "down" === a ? (f(!1), u.removeClass("splash"), Waypoint.disableAll(), Waypoint.enableAll()) : "up" === a && (f(!0), u.addClass("splash"))
        }, {
            offset: function () {
                return -(G.mobileMenu() ? x.outerHeight() : x.outerHeight() - s.outerHeight())
            }
        })
    }
    ...
    function j() {
        x.waypoint(function (a) {
            var b = G.siteSearch();
            "down" === a ? (B = "above", g(!1), u.removeClass("splash"), F("#splash-video").length && (F("#splash-video")[0].pause(), k())) : "up" === a && (B = "within", g(!b), F("#splash-video").length && !F("#splash-video").hasClass("paused") && "true" !== v.attr("aria-expanded") && "true" !== w.attr("aria-expanded") && (F("#splash-video")[0].play(), l()))
        }, {offset: h}), q.waypoint(function (a) {
            var b = G.siteSearch();
            "down" === a ? (u.removeClass("splash"), B = "within", b && g(!1)) : "up" === a && (u.addClass("splash"), B = "below", g(!0))
        }, {
            offset: function () {
                var a = A.outerHeight();
                return F(window).innerHeight() - a
            }
        })
    }

    function k() {
        F("#splash--pause i").removeClass("fa-pause-circle").addClass("fa-play-circle"), F("#splash--pause").attr("aria-label", "Play")
    }

    function l() {
        F("#splash--pause i").removeClass("fa-play-circle").addClass("fa-pause-circle"), F("#splash--pause").attr("aria-label", "Pause")
    }

    function m() {
        k(), F("#splash-video")[0].pause()
    }

    function n() {
        l(), F("#splash-video")[0].play()
    }

    function o() {
        F("#splash-video")[0].paused ? (F("#splash-video").removeClass("paused"), n()) : (F("#splash-video").addClass("paused"), m())
    }

    var p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F = jQuery, G = c(0), H = c(2);
    F(window).on("resizeEnd", function () {
        if (x) {
            var a = G.breakpointDetect(), b = F(window).height(), c = F(window).width();
            "object" == typeof E && E.css("height", q.height()), "xs" != a && "sm" != a ? e() : c != D ? e() : Math.abs(b - C) > 95 && e(), C = b, D = c
        }
    }), F(document).ready(function () {
        (x = H.splashPanel()) && (p = F("body > header"), q = F("#main"), r = F("body > footer"), s = F("#brand-bar"), u = F("#search-wrapper"), v = F("#search-toggle"), w = F("#menu-toggle"), t = F("#site-navigation"), A = F("#splash--scroller"), y = x.attr("class").match(/theme--\S+/), y = y ? y[0] : "theme--choco", z = x.attr("data-scroll-type") || "curtain", C = F(window).height(), D = F(window).width(), d())
    })
}, function (a, b, c) {
    "use strict";
    document.createElement("picture"), c(30)
}, function (a, b, c) {
    "use strict";
    var d = jQuery, e = {
        web: {
            button: '<i class="fa fa-globe"></i>&nbsp;Search Web',
            placeholder: "ï€‚Â Â Â  Search Stanford websites"
        },
        people: {
            button: '<i class="fa fa-users"></i>&nbsp;Search people',
            placeholder: "ï€‚Â Â Â  Search by name, SUNet, emailâ€¦"
        }
    };
    d('input[name="search_type"]').on("change", function () {
        var a = d(this), b = a.closest("form"), c = b.find('input[type="text"]'), f = b.find("button"),
            g = a.attr("value"), h = e[g];
        c.attr("placeholder", h.placeholder), f.html(h.button)
    }), 0 === d(".page-template-search-php").length ? d("#search-toggle, #search-overlay").click(function () {
        var a = d("#search-toggle"), b = d("#search-toggle, #site-search, #search-overlay"), c = d("#menu-toggle"),
            e = d('#main, footer, .panel[data-type="splash-image"] img, #splash--wordmark, #splash--scroller');
        "true" === a.attr("aria-expanded") ? (b.attr("aria-expanded", "false"), a.html("Search").blur(), a.trigger("close"), e.removeClass("blur")) : ("true" === c.attr("aria-expanded") && c.click(), b.attr("aria-expanded", "true"), a.trigger("open"), a.html("Close"), d("#search-field").focus(), e.addClass("blur"))
    }) : d("#search-toggle").attr("tabindex", "-1")
}, function (a, b, c) {
    "use strict";
    var d = jQuery;
    d(window).on("resizeEnd", function () {
        var a = c(0), b = (c(2), a.mobileMenu()), e = a.breakpointDetect(), f = d("#brand-bar"),
            g = d("#site-navigation"), h = d("#gateway"), i = d("#header--wordmark"), j = d("#search-toggle");
        Waypoint.disableAll(), Waypoint.enableAll(), h.length && (b ? 0 === d("#" + g[0].id + "> #" + h[0].id).length && h.attr("style", "display: none;").detach().appendTo(g).removeAttr("style") : 0 === d("#" + f[0].id + " > #" + h[0].id).length && h.attr("style", "display: none;").detach().insertBefore(j).removeAttr("style")), i.text("xs" == e ? "Stanford" : "Stanford University"), d(this).trigger("panelImageContentAdjust"), d(this).trigger("navKeyboardBindings")
    ...
    "use strict";
    var d = jQuery, e = (c(1), c(0)), f = e.splashPanel(), g = e.emergencyPage(), h = d("#main"),
        i = d(".entry-content"), j = d("#brand-bar"), k = d("#site-navigation"), l = j.outerHeight(),
        m = k.outerHeight();
    ...
    function d(a) {
        var b = f.splashPanel(), c = e("#brand-bar"), d = c.outerHeight(), g = e("#site-navigation"),
            h = g.outerHeight(), i = d + h, j = b ? e(window).innerHeight() - i : e(a).offset().top - i;
    ...
    e("a[href^='#']").click(function (a) {
        ...
        b.closest("ul#list-filters").length || (a.preventDefault(), e("html, body").animate({scrollTop: d(c)}, g), e(c).focus(), history.pushState(null, "", c))
    }), window.onload = function () {
        var a = e("skiplinks"), b = a.length ? a.attr("href") : "#main-content";
        e(b).attr("tabindex", "-1"), window.location.hash && !e("body").hasClass("archive") && e("html, body").animate({scrollTop: d(window.location.hash)}, 250)
    }
}, function (a, b, c) {
    var d;
    !function () {
        ...
        var f = navigator.userAgent.indexOf("Windows Phone") >= 0, g = navigator.userAgent.indexOf("Android") > 0 && !f,
            h = /iP(ad|hone|od)/.test(navigator.userAgent) && !f, i = h && /OS 4_\d(_\d)?/.test(navigator.userAgent),
            j = h && /OS [6-7]_\d/.test(navigator.userAgent), k = navigator.userAgent.indexOf("BB10") > 0;
    ...
    function f(a) {
        for (var b, c = getComputedStyle(a).fontFamily, d = {}; null !== (b = m.exec(c));) d[b[1]] = b[2];
        return d
    }
    ...
    function i(a) {
        var b = f(a), c = a[l];
        if (b["object-fit"] = b["object-fit"] || "fill", !c.img) {
            if ("fill" === b["object-fit"]) return;
            if (!c.skipTest && o && !b["object-position"]) return
        }
        if (!c.img) {
            c.img = new Image(a.width, a.height), c.img.srcset = s.call(a, "data-ofi-srcset") || a.srcset, c.img.src = s.call(a, "data-ofi-src") || a.src, t.call(a, "data-ofi-src", a.src), a.srcset && t.call(a, "data-ofi-srcset", a.srcset), g(a, a.naturalWidth || a.width, a.naturalHeight || a.height), a.srcset && (a.srcset = "");
            try {
                j(a)
            } catch (a) {
        ...
        e(c.img), a.style.backgroundImage = 'url("' + (c.img.currentSrc || c.img.src).replace(/"/g, '\\"') + '")', a.style.backgroundPosition = b["object-position"] || "center", a.style.backgroundRepeat = "no-repeat", a.style.backgroundOrigin = "content-box", /scale-down/.test(b["object-fit"]) ? h(c.img, function () {
            c.img.naturalWidth > a.width || c.img.naturalHeight > a.height ? a.style.backgroundSize = "contain" : a.style.backgroundSize = "auto"
        }) : a.style.backgroundSize = b["object-fit"].replace("none", "auto").replace("fill", "100% 100%"), h(c.img, function (b) {
    ...
    function j(a) {
        var b = {
            get: function (b) {
                ...
                return a[l].img[c || "src"] = b, t.call(a, "data-ofi-" + c, b), i(a), b
            }
        };
    ...
    function k(a, b) {
        var c = !u && !a;
        if (b = b || {}, a = a || "img", p && !b.skipTest || !q) return !1;
        "img" === a ? a = document.getElementsByTagName("img") : "string" == typeof a ? a = document.querySelectorAll(a) : "length" in a || (a = [a]);
        for (var d = 0; d < a.length; d++) a[d][l] = a[d][l] || {skipTest: b.skipTest}, i(a[d]);
        c && (document.body.addEventListener("load", function (a) {
            "IMG" === a.target.tagName && k(a.target, {skipTest: b.skipTest})
        }, !0), u = !0, a = "img"), b.watchMQ && window.addEventListener("resize", k.bind(null, a, {skipTest: b.skipTest}))
    }

    var l = "bfred-it:object-fit-images", m = /(object-fit|object-position)\s*:\s*([-.\w\s%]+)/g,
        n = "undefined" == typeof Image ? {style: {"object-position": 1}} : new Image, o = "object-fit" in n.style,
        p = "object-position" in n.style, q = "background-size" in n.style, r = "string" == typeof n.currentSrc,
        s = n.getAttribute, t = n.setAttribute, u = !1;
    k.supportsObjectFit = o, k.supportsObjectPosition = p, function () {
        function a(a, b) {
    ...
    !function (a) {
        ...
        function n(a, b) {
            var c, d, e;
            if (a && b) for (e = u.parseSet(b), a = u.makeUrl(a), c = 0; c < e.length; c++) if (a === u.makeUrl(e[c].url)) {
                d = e[c];
                break
            }
            return d
            ...
            for (var e, f, g, i, j, k = a.length, l = 0, m = []; ;) {
                ...
                e = c(U), f = [], "," === e.slice(-1) ? (e = e.replace(V, ""), d()) : function () {
                    for (c(S), g = "", i = "in descriptor"; ;) {
                        if (j = a.charAt(l), "in descriptor" === i) if (h(j)) g && (f.push(g), g = "", i = "after descriptor"); else {
                            if ("," === j) return l += 1, g && f.push(g), void d();
                            if ("(" === j) g += j, i = "in parens"; else {
                                if ("" === j) return g && f.push(g), void d();
                                g += j
                            }
                        } else if ("in parens" === i) if (")" === j) g += j, i = "in descriptor"; else {
                            if ("" === j) return f.push(g), void d();
                            g += j
                        } else if ("after descriptor" === i) if (h(j)) ; else {
                            if ("" === j) return void d();
                            i = "in descriptor", l -= 1
                        }
                        l += 1
        ...
        function q(a) {
            var b, c, d, e, f, g,
                i = /^(?:[+-]?[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?(?:ch|cm|em|ex|in|mm|pc|pt|px|rem|vh|vmin|vmax|vw)$/i,
                j = /^calc\((?:[0-9a-z \.\+\-\*\/\(\)]+)\)$/i;
            for (c = function (a) {
                function b() {
                    e && (f.push(e), e = "")
                ...
                for (var d, e = "", f = [], g = [], i = 0, j = 0, k = !1; ;) {
                    ...
                    if (k) {
                        ...
                        if (h(d)) {
                            ...
                            d = " "
                        } else if ("(" === d) i += 1; else if (")" === d) i -= 1; else {
                            if ("," === d) {
                                b(), c(), j += 1;
                                continue
                            }
            ...
            }(a), d = c.length, b = 0; b < d; b++) if (e = c[b], f = e[e.length - 1], function (a) {
        ...
        var r, s, t, u = {}, v = !1, w = function () {
            }, x = f.createElement("img"), y = x.getAttribute, z = x.setAttribute, A = x.removeAttribute,
            B = f.documentElement, C = {}, D = {algorithm: ""}, E = navigator.userAgent,
            F = /rident/.test(E) || /ecko/.test(E) && E.match(/rv\:(\d+)/) && RegExp.$1 > 35, G = "currentSrc",
            H = /\s+\+?\d+(e\d+)?w/, I = /(\([^)]+\))?\s*(.+)/, J = e.picturefillCFG, K = "font-size:100%!important;",
            L = !0, M = {}, N = {}, O = e.devicePixelRatio, P = {px: 1, in: 96}, Q = f.createElement("a"), R = !1,
            S = /^[ \t\n\r\u000c]+/, T = /^[, \t\n\r\u000c]+/, U = /^[^ \t\n\r\u000c]+/, V = /[,]+$/, W = /^\d+$/,
            X = /^-?(?:[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?$/, Y = function (a, b, c, d) {
        ...
        e.console && console.warn, G in x || (G = "src"), C["image/jpeg"] = !0, C["image/gif"] = !0, C["image/png"] = !0, C["image/svg+xml"] = f.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1"), u.ns = ("pf" + (new Date).getTime()).substr(0, 9), u.supSrcset = "srcset" in x, u.supSizes = "sizes" in x, u.supPicture = !!e.HTMLPictureElement, u.supSrcset && u.supPicture && !u.supSizes && function (a) {
            ...
            var a = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==",
                b = f.createElement("img"), c = function () {
                    2 === b.width && (u.supSizes = !0), s = u.supSrcset && !u.supSizes, v = !0, setTimeout(aa)
                };
            b.onload = c, b.onerror = c, b.setAttribute("sizes", "9px"), b.srcset = a + " 1w,data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw== 9w", b.src = a
            ...
            var a;
            if (!r && (a = f.body)) {
                var b = f.createElement("div"), c = B.style.cssText, d = a.style.cssText;
            ...
            if (a.length) {
                ...
                if (h = o.curSrc || b[G], i = o.curCan || m(b, h, a[0].set), i && i.set === a[0].set && ((n = F && !b.complete && i.res - .1 > p) || (i.cached = !0, i.res >= p && (g = i))), !g) for (a.sort(l), f = a.length, g = a[f - 1], d = 0; d < f; d++) if (c = a[d], c.res >= p) {
            ...
            for (b = 0; b < f.length && !e; b++) if (c = f[b], c.srcset && u.matchesMedia(c.media) && (d = u.supportsType(c.type))) {
                "pending" === d && (c = d), e = c;
                break
            }
            return e
            ...
            push: function (a) {
                var b = a.shift();
                "function" == typeof u[b] ? u[b].apply(u, a) : (D[b] = a[0], R && u.fillImgs({reselect: !0}))
            }
        };
    ...
    !function () {
        ...
        }, b.defaults = {context: window, enabled: !0, enter: a, entered: a, exit: a, exited: a}, c.Inview = b
    }()
}, , function (a, b, c) {
    "use strict";
    Object.defineProperty(b, "__esModule", {value: !0});
    var d = c(13), e = (c.n(d), c(8)), f = (c.n(e), c(10)), g = (c.n(f), c(7)), h = (c.n(g), c(23)), i = (c.n(h), c(6)),
        j = (c.n(i), c(9)), k = (c.n(j), c(14)), l = (c.n(k), c(24)), m = (c.n(l), c(11)), n = (c.n(m), c(25)),
        o = (c.n(n), c(26)), p = (c.n(o), c(27)), q = (c.n(p), c(12)), r = (c.n(q), c(22)), s = (c.n(r), c(15)),
        t = (c.n(s), c(16)), u = (c.n(t), c(17)), v = (c.n(u), c(18)), w = (c.n(v), c(21)), x = (c.n(w), c(20)),
        y = (c.n(x), c(19));
    c.n(y);
